...
function ConfirmDialog({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      fontSize: 14,
      fontWeight: 600,
      color: destructive ? '#fff' : 'var(--charcoal)',
      background: destructive ? 'var(--error)' : 'linear-gradient(135deg, var(--gold-600), var(--gold-400))'
    }
  }, confirmLabel))));
}
