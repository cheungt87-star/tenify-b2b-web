...
(() => {
  ...
  class DocPage extends HTMLElement {
    ...
    _scheduleMeasure() {
      if (this._raf) return;
      // setTimeout, not requestAnimationFrame: some preview/host contexts
      // never fire rAF callbacks (the render loop is paused/throttled for
      // an inactive or headless-composited iframe), which would silently
      // strand every scheduled measure forever. setTimeout(0) always fires.
      this._raf = setTimeout(() => { this._raf = null; this._measure(); }, 0);
    }
